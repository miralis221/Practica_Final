...
const Hora_solar_pico(),Text('Hora Solar Pico:',style: GoogleFonts.roboto(fontSize: 25.0, color: AppColors.color4, fontWeight: FontWeight.w700, ),textAlign: TextAlign.center, ),
        ...
        ),Spacer(flex: 39),Align(alignment: Alignment.centerRight, child: 
            SizedBox(
            width: 302.0,
            height: 88.0,
            child: Stack(
                ...
                children: <Widget>[const Consumo_abastecer(),
        Positioned(
            left: 113.0,
            bottom: 8.0,
            child: Text('4,60',style: GoogleFonts.roboto(fontSize: 30.0, color: AppColors.color4, fontWeight: FontWeight.w700, ),textAlign: TextAlign.center, ),
        )
        ,
        Positioned(
            left: 113.0,
        ...
        ),),Spacer(flex: 66),const Boton_calcular(),],
            ),
        ),
        )
        ,
