...
import 'Consumoreal.dart';
        ...
        class GooglePixel517 extends StatelessWidget {
          const GooglePixel517({Key key}) : super(key: key);    
        ...
        InkWell(
            onTap: (){
                //TODO: onTap Google Pixel 5 – 17
                print('onTap Google Pixel 5 – 17');
            },
            child: Scaffold(
        ...
        Positioned(
            ...
            child: Text('250 w',style: GoogleFonts.roboto(fontSize: 30.0, color: AppColors.color6, fontWeight: FontWeight.w700, ),textAlign: TextAlign.center, ),
        )
        ,],
            ),
