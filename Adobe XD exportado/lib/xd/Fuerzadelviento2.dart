...
import 'package:google_fonts/google_fonts.dart';
        ...
        class Fuerzadelviento2 extends StatelessWidget {
          const Fuerzadelviento2({Key key}) : super(key: key);    
        ...
        InkWell(
            ...
            child:Text('60 m',style: GoogleFonts.roboto(fontSize: 20.0, color: AppColors.color4, fontWeight: FontWeight.w700, ),textAlign: TextAlign.center, ),
        ),
            ...
            height: 55.0,
            decoration: BoxDecoration(borderRadius: BorderRadius.circular(28.0), color: AppColors.color1.0, border: Border.all(width: 1.0, color: AppColors.color2.0,), ), 
            child:Text.rich(TextSpan(  style: GoogleFonts.roboto(fontSize: 16.0, color: AppColors.color6, ),  children: [TextSpan( text: '30kw',), TextSpan( text: 'h/día',), ],), textAlign: TextAlign.center, ),
            ...
            height: 55.0,
            decoration: BoxDecoration(borderRadius: BorderRadius.circular(28.0), color: AppColors.color1.0, border: Border.all(width: 1.0, color: AppColors.color2.0,), ), 
            child:Text('10 m/s',style: GoogleFonts.roboto(fontSize: 20.0, color: AppColors.color4, fontWeight: FontWeight.w700, ),textAlign: TextAlign.center, ),
        ),),Spacer(flex: 108),
            SizedBox(
            width: 320.0,
            height: 47.0,
