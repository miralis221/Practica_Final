...
import 'package:google_fonts/google_fonts.dart';
        ...
        class GeneradorEolico1 extends StatelessWidget {
          const GeneradorEolico1({Key key}) : super(key: key);    
          
          @override
          Widget build(BuildContext context) {
            return Scaffold(
            backgroundColor: AppColors.Primary / 200 🌑,
            body:Align(alignment: Alignment(-0.03,-0.87), child: 
            SizedBox(
            width: 286.0,
            height: 760.0,
            child: Column(
        ...
        InkWell(
            ...
            height: 55.0,
            decoration: BoxDecoration(borderRadius: BorderRadius.circular(28.0), color: AppColors.color1.0, border: Border.all(width: 1.0, color: AppColors.color2.0,), ), 
            child:Text('CONSUMO A ABASTECER',style: GoogleFonts.roboto(fontSize: 16.0, color: AppColors.color6, ),textAlign: TextAlign.center, ),
        ),
        ),),Spacer(flex: 515),],
            ),
        ),),
