...
import 'Consumoreal.dart';
        ...
        class GooglePixel516 extends StatelessWidget {
          const GooglePixel516({Key key}) : super(key: key);    
        ...
        InkWell(
            onTap: (){
                //TODO: onTap Google Pixel 5 – 16
                print('onTap Google Pixel 5 – 16');
            },
            child: Scaffold(
        ...
        Positioned(
            left: 66.0,
            bottom: 8.0,
            child: Text('6917,30',style: GoogleFonts.roboto(fontSize: 30.0, color: AppColors.Primary / 900, fontWeight: FontWeight.w700, ),textAlign: TextAlign.center, ),
        )
        ,
        Positioned(
            right: 77.0,
